...
public class JitCompiler extends ExecutionEngine {
	public JitCompiler(Module mod) throws Exception {
		super(null);
		...
		boolean success = org.jllvm.bindings.ExecutionEngine.LLVMCreateJITCompilerForModule(engines,mod.getInstance(),0,outerrs) > 0;
