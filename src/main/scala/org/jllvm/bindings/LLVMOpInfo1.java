...
public class LLVMOpInfo1 {
  ...
  public void setValue(LLVMOpaqueUint64_t value) {
    DisassemblerJNI.LLVMOpInfo1_Value_set(swigCPtr, this, LLVMOpaqueUint64_t.getCPtr(value));
  }

  public LLVMOpaqueUint64_t getValue() {
    return new LLVMOpaqueUint64_t(DisassemblerJNI.LLVMOpInfo1_Value_get(swigCPtr, this), true);
  }

  public void setVariantKind(LLVMOpaqueUint64_t value) {
    DisassemblerJNI.LLVMOpInfo1_VariantKind_set(swigCPtr, this, LLVMOpaqueUint64_t.getCPtr(value));
  }

  public LLVMOpaqueUint64_t getVariantKind() {
    return new LLVMOpaqueUint64_t(DisassemblerJNI.LLVMOpInfo1_VariantKind_get(swigCPtr, this), true);
  }
